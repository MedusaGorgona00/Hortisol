...
{
    internal static void RegisterNativeLogger(this IServiceCollection services)
    {
        services.AddHttpLogging(x =>
        {
            ...
            x.RequestBodyLogLimit = 42 * 1024;
            x.ResponseBodyLogLimit = 42 * 1024;
        });
    }
    ...
    internal static void RegisterServiceUri(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        AppConstants.BaseFrontUri = settings.Self.BaseFrontUri;
    }
